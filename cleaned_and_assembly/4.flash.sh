...
FASTQ_PATH="/home/marcos/PRJNA46333/cleaned_reads" 
OUTPUT_PATH="/home/marcos/PRJNA46333/merged_reads" 
...
for FILE1 in "$FASTQ_PATH"/*_R1.fastq; do
  ...
  if [ -f "$FILE2" ]; then
    ...
    # -M 150: avoids the WARNING from FLASH saying that many sequences overlap more than the parameter, 
    #but it didn't change the merge percentage
  else
