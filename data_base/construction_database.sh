...
#This list was subjected to CDHit (script available) for removal of redundancy at 100% identity, resulting in the final non-redundant list of accessions used to download the sequences from ncbi using another script (available).